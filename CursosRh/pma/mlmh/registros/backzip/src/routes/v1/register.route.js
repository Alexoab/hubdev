...
router
  ...
  .get(auth('padrao'), validate(registerValidation.getRegisters), registerController.getRegisters);
router.route('/eliminados').get(auth('padrao'), registerController.getRegistersEliminados);

router.route('/img/:cpf').get(validate(registerValidation.getDocument), registerController.getDocument);
router
  .route('/atualizarparcial')
  .put(validate(registerValidation.atualizarParcial), registerController.updateParcialRegister);
