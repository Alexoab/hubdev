...
router.post('/forgotpasswordotp', validate(authValidation.forgotPasswordOtp), authController.forgotPasswordOtp);
router.post('/resetpassword', validate(authValidation.resetPassword), authController.resetPassword);
router.post('/resetpasswordotp', validate(authValidation.resetPasswordOtp), authController.resetPasswordOtp);
router.post('/resetpasswordbackend', validate(authValidation.forgotPassword), authController.resetSenhaBackend);
