 ...
 * @returns {Promise}
 */
const sendOtpResetPassword = async (to, otpToken, user) => {
    ...
    <tbody>
      ...
      <tr>
        ...
        >
          <div>
            <p>
              <strong>Olá, ${user.name}.</strong><br /><br />
              Recebemos uma solicitação para redefinição de senha da sua conta.
              Para redefinir a senha de acesso, digite o número abaixo no local solicitado!
              <br /><br />
              <h1 style="color: #3182ce; text-align: center;">${otpToken}</h1>
              <br /><br />
              Se você não fez essa solicitação, ignore esse email.
              <br />
              Esse código expira em 1 hora.
            </p>
          </div>
          <br />
          <br />
